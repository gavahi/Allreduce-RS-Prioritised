...
/* Configure arguments */
#define HYDRA_CONFIGURE_ARGS_CLEAN "'--disable-option-checking' '--prefix=/home/gavahi/allreduce-RS-Prioritised2/mvapich2-2.3.3/Install_mvapich' '--cache-file=/dev/null' '--srcdir=.' 'CC=gcc' 'CFLAGS= -DNDEBUG -DNVALGRIND -O2' 'LDFLAGS=-L/lib -L/lib -L/lib -Wl,-rpath,/lib -L/lib -Wl,-rpath,/lib -L/lib -L/lib' 'LIBS=-libmad -lrdmacm -libumad -libverbs -ldl -lrt -lm -lpthread ' 'CPPFLAGS= -I/home/gavahi/allreduce-RS-Prioritised2/mvapich2-2.3.3/src/mpl/include -I/home/gavahi/allreduce-RS-Prioritised2/mvapich2-2.3.3/src/mpl/include -I/home/gavahi/allreduce-RS-Prioritised2/mvapich2-2.3.3/src/openpa/src -I/home/gavahi/allreduce-RS-Prioritised2/mvapich2-2.3.3/src/openpa/src -D_REENTRANT -I/home/gavahi/allreduce-RS-Prioritised2/mvapich2-2.3.3/src/mpi/romio/include -I/include -I/include -I/include -I/include' 'MPLLIBNAME=mpl'"
...
#define HYDRA_RELEASE_DATE "General Availability Release"
