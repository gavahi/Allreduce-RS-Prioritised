...
FORT_DLL_SPEC void FORT_CALL mpirinitc_(void *si, void *ssi,
                                        void *bt, void *ip,
                                        void *uw, void *ecsi,
                                        void *asn FORT_MIXED_LEN(d1), void *we FORT_END_LEN(d1));
...
FORT_DLL_SPEC void FORT_CALL mpirinitc2_(char *an FORT_MIXED_LEN(d1) FORT_END_LEN(d1))
{
    *an = ' ';
}
...
/* *INDENT-OFF* */
FORT_DLL_SPEC mpif_cmblk5_t mpifcmb5r __attribute__((aligned(16))) = {0};
/* *INDENT-ON* */
...
/* *INDENT-OFF* */
FORT_DLL_SPEC mpif_cmblk9_t mpifcmb9r __attribute__((aligned(16))) = {0};
/* *INDENT-ON* */
