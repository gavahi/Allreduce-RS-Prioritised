...
type(MPI_Datatype), parameter   :: MPI_BYTE            = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UB              = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_LB              = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_PACKED          = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INTEGER1        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INTEGER2        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INTEGER4        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INTEGER8        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INTEGER16       = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_REAL4           = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_REAL8           = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_REAL16          = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_COMPLEX8        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_COMPLEX16       = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_COMPLEX32       = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_CHAR            = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_SIGNED_CHAR     = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UNSIGNED_CHAR   = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_WCHAR           = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_SHORT           = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UNSIGNED_SHORT  = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INT             = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UNSIGNED        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_LONG            = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UNSIGNED_LONG   = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_FLOAT           = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_DOUBLE          = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_LONG_DOUBLE     = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_LONG_LONG_INT   = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UNSIGNED_LONG_LONG = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_LONG_LONG       = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_FLOAT_INT       = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_DOUBLE_INT      = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_LONG_INT        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_SHORT_INT       = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_2INT            = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_LONG_DOUBLE_INT = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INT8_T          = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INT16_T         = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INT32_T         = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_INT64_T         = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UINT8_T         = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UINT16_T        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UINT32_T        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_UINT64_T        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_C_BOOL          = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_C_FLOAT_COMPLEX = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_C_COMPLEX       = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_C_DOUBLE_COMPLEX = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_C_LONG_DOUBLE_COMPLEX = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_AINT            = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_OFFSET          = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_COUNT           = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_CXX_BOOL        = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_CXX_FLOAT_COMPLEX = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_CXX_DOUBLE_COMPLEX = MPI_Datatype()
type(MPI_Datatype), parameter   :: MPI_CXX_LONG_DOUBLE_COMPLEX = MPI_Datatype()
